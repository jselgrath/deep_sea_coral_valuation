...
d0_d<-read_csv("./results/nomults_port_bl.csv")%>%    glimpse()
d0_e<-read_csv("./results/nomults_commodity_bl.csv")%>%    glimpse()
d0_f<-read_csv("./results/nomults_annrev_bl.csv")%>%    glimpse()
...
d1_d<-read_csv("./results/nomults_port_pr.csv")%>%    glimpse()
d1_e<-read_csv("./results/nomults_commodity_pr.csv")%>%    glimpse()
d1_f<-read_csv("./results/nomults_annrev_pr.csv")%>%    glimpse()
...
d2_d<-read_csv("./results/nomults_port_ha12.csv")%>%    glimpse()
d2_e<-read_csv("./results/nomults_commodity_ha12.csv")%>%    glimpse()
d2_f<-read_csv("./results/nomults_annrev_ha12.csv")%>%    glimpse()
...
d3_d<-read_csv("./results/nomults_port_all.csv")%>%    glimpse()
d3_e<-read_csv("./results/nomults_commodity_all.csv")%>%    glimpse()
d3_f<-read_csv("./results/nomults_annrev_all.csv")%>%    glimpse()
...
# no multiplier, commodity/state ------------------
f_longer_noMult2<-function(dta){
  dta%>%
    pivot_longer(cols=-c(year,assoc,COMMCD,COMMCD2),names_to="metric",values_to="value_noMult")%>%
    mutate(metric="revenue_commodity")
}


# commodity
d0_eL<-f_longer_noMult2(d1_e)%>%
  mutate(value_noMult_bl=value_noMult,assoc_noMult_bl=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d1_eL<-f_longer_noMult2(d1_e)%>%
  mutate(value_noMult_pr=value_noMult,assoc_noMult_pr=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d2_eL<-f_longer_noMult2(d2_e)%>%
  mutate(value_noMult_ha12=value_noMult,assoc_noMult_ha12=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d3_eL<-f_longer_noMult2(d3_e)%>%
  mutate(value_noMult_allSp=value_noMult,assoc_noMult_allSp=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()


# no multiplier, state ------------------
f_longer_noMult3<-function(dta){
  dta%>%
    pivot_longer(cols=-c(year,assoc),names_to="metric",values_to="value_noMult")%>%
    mutate(metric="revenue_annual")
}

# state, annual
d0_fL<-f_longer_noMult3(d1_f)%>%
  mutate(value_noMult_bl=value_noMult,assoc_noMult_bl=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d1_fL<-f_longer_noMult3(d1_f)%>%
  mutate(value_noMult_pr=value_noMult,assoc_noMult_pr=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d2_fL<-f_longer_noMult3(d2_f)%>%
  mutate(value_noMult_ha12=value_noMult,assoc_noMult_ha12=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
d3_fL<-f_longer_noMult3(d3_f)%>%
  mutate(value_noMult_allSp=value_noMult,assoc_noMult_allSp=assoc)%>%select(!value_noMult,-assoc)%>%unique()%>%glimpse()
...
write_csv(d0_dL,"./results/ec_noMult_port_bl_long.csv")
write_csv(d1_dL,"./results/ec_noMult_port_pr_long.csv")
write_csv(d2_dL,"./results/ec_noMult_port_ha12_long.csv")
write_csv(d3_dL,"./results/ec_noMult_port_allSp_long.csv")

write_csv(d0_eL,"./results/ec_noMult_state_bl_long.csv")
write_csv(d1_eL,"./results/ec_noMult_state_pr_long.csv")
write_csv(d2_eL,"./results/ec_noMult_state_ha12_long.csv")
write_csv(d3_eL,"./results/ec_noMult_state_allSp_long.csv")

write_csv(d0_fL,"./results/ec_noMult_annual_bl_long.csv")
write_csv(d1_fL,"./results/ec_noMult_annual_pr_long.csv")
write_csv(d2_fL,"./results/ec_noMult_annual_ha12_long.csv")
write_csv(d3_fL,"./results/ec_noMult_annual_allSp_long.csv")
